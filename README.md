...
- [Enterprise RAG Pipeline](#enterprise-rag-pipeline)
  ...
  - [Run Modes](#run-modes)
    - [1) Containerized Mode (Primary)](#1-containerized-mode-primary)
    - [2) Local Script Mode](#2-local-script-mode)
  - [Core Implementation Walkthrough](#core-implementation-walkthrough)
    - [1) Intake and Safe File Persistence](#1-intake-and-safe-file-persistence)
    - [2) Async Dispatch With Degraded Fallback](#2-async-dispatch-with-degraded-fallback)
    - [3) Worker Status Discipline](#3-worker-status-discipline)
    - [4) UI Polling and Observability](#4-ui-polling-and-observability)
  - [Operational Runbook](#operational-runbook)
    - [Health and Quick Checks](#health-and-quick-checks)
